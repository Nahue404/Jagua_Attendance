...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($codigo === "unida20") {
        ...
        // Contraseña correcta
        $destino = isset($_GET['destino']) ? $_GET['destino'] : 'lista_alumnos.php'; // Obtener el destino o usar 'menu.php' como valor predeterminado
...
<body>
    ...
    <div class="formulario">
        ...
        <form action="" method="POST"> 
            ...
            <a href="TomarAsistencia.php" class="boton">Volver</a>
        </form>
