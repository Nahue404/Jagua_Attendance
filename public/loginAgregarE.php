...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($codigo === "unida20") {
        ...
        $_SESSION['usuario_autenticadoL'] = true;
        // Contraseña correcta
        $destino = isset($_GET['destino']) ? $_GET['destino'] : 'https://faceapi-6ff36.web.app/upload'; // Obtener el destino o usar 'menu.php' como valor predeterminado
...
<body>
    ...
    <div class="formulario">
        ...
        <form action="" method="POST"> 
            ...
            <a href="menu.php" class="boton">Volver</a>
        </form>
